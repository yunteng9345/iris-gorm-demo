...
type BookRepository interface {
	GetBookList(m map[string]interface{}) (total int64, books []models.Book)
...
func (n bookRepository) GetBookList(m map[string]interface{}) (total int64, books []models.Book) {
